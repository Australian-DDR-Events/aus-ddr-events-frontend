        ...
        <>
            ...
            <Space direction='horizontal'>
                <Link href='https://www.facebook.com/groups/2053507828081261'>
                    <SmallWidthImage src="https://i.imgur.com/DG4HgJn.png" preview={false}/>
                </Link>
                <Link href='https://discord.gg/DsKWPxY4V7' title='discord'>
                    <SmallWidthImage src="https://i.imgur.com/zGzeQ7G.png" preview={false}/>
                </Link>
                <Link href='mailto:ausddrevents@gmail.com' title='gmail'>
                    <SmallWidthImage src="https://i.imgur.com/j1aQgYK.png" preview={false}/>
                </Link>
            </Space>
            <Typography.Paragraph style={{color: '#f2f2f2'}}>    
